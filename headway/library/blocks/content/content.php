	...
	public $inputs = array(
		...
		'display' => array(
			...
			'show-single-post-navigation-enable-tax' => array(
				...
				'default' => false,
				'tooltip' => 'If you have Show Single Post Navigation turned on, by default WordPress/Headway will show links the next and previous post in chronological order. If you want the next/previous posts to only link to posts in the same taxonomy as the current post, enable this.',
				'toggle' => array(
		...
		'post-thumbnails' => array(
			...
			'post-thumbnails-link' => array(
				...
				'tooltip' => 'By default, Headway will create a link around the featured image which links back to the post. Choose no link or to link to the image\'s attachment page instead.'
			),
